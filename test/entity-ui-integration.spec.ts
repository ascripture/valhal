import { EntityStore, EntityUIState } from '../src';

describe('EntityUIIntegration', () => {
    it('connects any entity with ui data', () => {
        const entityStore = new EntityStore<EntityUIState<{ id: string; value: number; }, { isLoading: boolean; }>, string, { globalLoading: boolean; }>(
            {
                idPath: ['entity', 'id']
            }
        );
